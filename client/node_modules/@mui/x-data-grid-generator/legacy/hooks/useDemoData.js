...
export var getColumnsFromOptions = function getColumnsFromOptions(options) {
...
export var getInitialState = function getInitialState(options, columns) {
  ...
  var groupingField = (_options$treeData = options.treeData) == null ? void 0 : _options$treeData.groupingField;
